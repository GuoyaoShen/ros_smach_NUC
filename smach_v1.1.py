...
# define states for Lower Behavior Functions
# class LF_KeepCenter(smach.State):
#     def __init__(self):
#         smach.State.__init__(self,
#                              outcomes=['sent_LF_KeepCenter'], )
#
#     def execute(self, userdata):
#         rate = rospy.Rate(2)
#
#         # Publish topics
#         pub = rospy.Publisher('TOPICS_KEEP_CENTER', 'MSG_KEEP_CENTER', queue_size=1)
#         pub.publish('MSG_KEEP_CENTER')
#         rospy.loginfo('TOPICS_KEEP_CENTER published')
#         return 'sent_LF_KeepCenter'
# class LF_DefaultAction(smach.State):
...
# define states for Upper Behavior Functions
